...
<body>
    <div class="main-container">
        ...
        <div class="logo-container">
            ...
            <img class="logo" src="lastest-logo.svg">
            <div class="button">
                <a href="FINAL-MECHANICS.html"><button id="play" onclick="playButtonClickAndSound()">PLAY</button></a>
                <a href="Leaderboards.php"><button id="leaderboards" onclick="playButtonClickAndSound()">Leaderboards</button></a>
            </div>
        </div>
    </div>
